...
// @generated
// Checksum : 2/HkpvCRn/9Sa9CrG9jVkw==
	...
	for !in.IsDelim('}') {
		...
		case "recurRequest":
			if in.IsNull() {
				...
				easyjsonBea79dfbDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(in, &*out.RecurRequest)
			}
...
func easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarNormal1(out *jwriter.Writer, in Bar_Normal_Args) {
	...
	if in.RecurRequest == nil {
		...
		easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(out, *in.RecurRequest)
	}
	out.RawByte('}')
}
