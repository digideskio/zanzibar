...
// @generated
// Checksum : tJKKZx5Lyrg056Kz3igHyQ==
...
func easyjsonBea79dfbDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBarBarNormal1(in *jlexer.Lexer, out *Bar_Normal_Args) {
	...
	for !in.IsDelim('}') {
		...
		case "stringList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v8 string
					v8 = string(in.String())
					out.StringList = append(out.StringList, v8)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "recurRequest":
			if in.IsNull() {
				...
				if out.RecurRequest == nil {
					out.RecurRequest = new(BarRequestRecur)
				}
				easyjsonBea79dfbDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(in, &*out.RecurRequest)
			}
			RecurRequestSet = true
		default:
			in.SkipRecursive()
		}
		in.WantComma()
	...
	if !RecurRequestSet {
		in.AddError(fmt.Errorf("key 'recurRequest' is required"))
	}
}
func easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBarBarNormal1(out *jwriter.Writer, in Bar_Normal_Args) {
	...
	if len(in.StringList) != 0 {
		...
		if in.StringList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v9, v10 := range in.StringList {
				if v9 > 0 {
					out.RawByte(',')
				}
	...
	first = false
	out.RawString("\"recurRequest\":")
	if in.RecurRequest == nil {
		out.RawString("null")
	} else {
		easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(out, *in.RecurRequest)
	}
	out.RawByte('}')
}
