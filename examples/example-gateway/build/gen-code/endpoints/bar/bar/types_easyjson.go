...
// @generated
// Checksum : HhAhZRerrlD49GcVzEowtg==
...
func easyjson6601e8cdDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(in *jlexer.Lexer, out *NestedField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(out *jwriter.Writer, in NestedField) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjson6601e8cdDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar5(in *jlexer.Lexer, out *BarRequest) {
	...
	if !NestedFieldSet {
		in.AddError(fmt.Errorf("key 'nestedField' is required"))
	}
}
